...
class Y extends MeshPhysicalMaterial {
  ...
  constructor(params: any) {
    super(params);
    this.defines = Object.assign(this.defines || {}, { USE_UV: '' });
...
const XDefaultConfig = {
  count: 200,
  colors: [0x10B981, 0x34D399, 0x059669],
...
class Z extends InstancedMesh {
  config: typeof XDefaultConfig;
  physics: W;
  ambientLight: AmbientLight | undefined;
  light: PointLight | undefined;

  constructor(renderer: WebGLRenderer, params: Partial<typeof XDefaultConfig> = {}) {
    const config = { ...XDefaultConfig, ...params };
    ...
    const material = new Y({ 
      envMap: envTexture, 
      transmission: 0.3, // Reduced for better performance and readability
      thickness: 1.0,
      ior: 1.5,
      ...
      const colorUtils = (function (colorsArr: number[]) {
        ...
        return {
          ...
          getColorAt: (ratio: number, out: Color = new Color()) => {
            ...
            if (baseColors.length === 1) return colorObjects[0].clone();
